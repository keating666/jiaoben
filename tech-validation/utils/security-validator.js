...
class SecurityValidator {
     ...
     */
    static validateAuthorizationHeader(authHeader) {
        // 处理 undefined 和空字符串
...
// URL最大长度限制
SecurityValidator.URL_MAX_LENGTH = 2048;
// API Token 最小长度
SecurityValidator.API_TOKEN_MIN_LENGTH = 32;
// 被阻止的主机名列表（云服务元数据端点）
SecurityValidator.BLOCKED_HOSTS = [
...
// 内网地址正则表达式
SecurityValidator.PRIVATE_IP_PATTERNS = [
    /^localhost$/i,
    /^127\./, // 127.0.0.0/8
    /^10\./, // 10.0.0.0/8
